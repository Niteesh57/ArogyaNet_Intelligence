...
const Patients = () => {
  ...
  const [form, setForm] = useState({ full_name: "", age: "", gender: "male", phone: "", hospital_id: "", assigned_doctor_id: "" });
    ...
    <div>
      <PageHeader title="Patients" action={
        <div className="flex items-center gap-3">
          ...
          {isAdmin && <GlassButton onClick={() => { setForm({ full_name: "", age: "", gender: "male", phone: "", hospital_id: user?.hospital_id || "", assigned_doctor_id: "" }); setModal(true); }}><Plus className="w-4 h-4 mr-1 inline" />Add Patient</GlassButton>}
        </div>
      } />
      {loading ? <Shimmer /> : (
